...
sub processCmd{
	...
	my %commands = (
		...
		"-t"                   => {"numArgs" => 1, "validArgs" => '^[0-9](\.[0-9]+)?$', "var" => $args{"PROBABILITY_THRESHOLD"}},
		"--threshold"          => {"numArgs" => 1, "validArgs" => '^[0-9](\.[0-9]+)?$', "var" => $args{"PROBABILITY_THRESHOLD"}},
		...
		"-l"                   => {"numArgs" => 1, "validArgs" => '^[0-9](\.[0-9]+)?$', "var" => $args{"LOW_COMPLEXITY"}},
		"--low-complexity"     => {"numArgs" => 1, "validArgs" => '^[0-9](\.[0-9]+)?$', "var" => $args{"LOW_COMPLEXITY"}},
